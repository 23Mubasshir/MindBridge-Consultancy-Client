        ...
        <div className="hero-content grid grid-cols-1 lg:grid-cols-2 md:p-20 shadow-[0px_22px_100px_4px_rgba(0,0,0,0.3)]  rounded-xl">
          <div className="p-10 md:p-0">
            ...
            <div className="">
                ...
                <h1 className="text-5xl font-semibold py-4" >Let&apos;s have a Free one on one session</h1>
                <p className="text-[20px]" >1-2-1 Consultancy sessions can be booked either as individual sessions, or alternatively we are able to offer packages of multiple sessions, payable in advance. But for the first time it is free for once.</p>
            </div>
          </div>
